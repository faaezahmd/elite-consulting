<template>
    <div class="negative-card-wrapper">
        <div class="negative-content">
            <h1 class="heading" data-aos-delay="100" data-aos="fade-up">Negative experiences impact us <br> all differently</h1>
            <div class="negative-cards">
                <div class="card" data-aos-delay="100" data-aos="fade-in">
            ...
            <p class="sub-heading" data-aos-delay="100" data-aos="fade-up">
                Negative experiences can create lasting impact, Elite Consulting has brought a team of experts to help you
                get "un"-stuck so you can pursue your dreams.
            </p>
        </div>
    </div>
</template>
