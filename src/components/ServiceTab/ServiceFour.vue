<template>
    <div class="service-card-wrapper">
        ...
        <p class="descruption">
            ...
            Everyone deserves peace at home. Sometimes navigating relationships can be difficult.
            <br>
...
Whether it is navigating your relationships with your significant other or concerns with your kids, Elite Consulting provides tools and resources to help you create the solutions that work for you and your family.
        ...
        <div class="service-image" data-aos="zoom-in">
            <div class="mession-text">
                ...
                <h1 class="heading">Family and Couples Therapy
                </h1>
                <p class="sub-title">Options for all ages
...
.service-image{
    ...
    background-image: url(/src/assets/images/n7.jpg);
